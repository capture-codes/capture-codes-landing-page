<script>
  import festivalVideographer from "./lib/assets/landing-page/festival-videographer.jpg";
  ...
  function updateRoute() {
    ...
    if (hash === "#/terms-of-website" || hash === "#/terms") {
      page = "terms";
...
{:else}
  <main>
    <section class="hero">
      <img
        class="hero-bg"
        src={festivalVideographer}
        alt="Festival videographer filming"
      />
